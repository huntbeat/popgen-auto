...
def msprime_to_dif(length, mu, n_e, recomb, window, win_stat):
    ...
    bottleneck = msprime.PopulationParametersChange(time=200,initial_size=500)
...
def main():
    ...
    out_filename = "msprime_" + opts.length + "_m" + opts.mu + "_Ne" + opts.n_e + "_r" + opts.recomb + "_w" + opts.window + "popchange"
