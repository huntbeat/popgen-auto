...
# ssheehan, June 2015
# example command:
# python mid_parallel.py -d /scratch/saralab/second/MXL_demo.txt -m /scratch/saralab/third/ -c 8
...
# selection strength
S_LST = 0.05/2 # selection strengths - low, mid, high : [0.001/2, 0.01/2, 0.1/2]
...
demo_path = opts.msms_folder + 'mid/'
