...
nat_D_list, nat_S_list = parse_msms('simNatK.txt')
D_list.extend(nat_D_list)
S_list.append(nat_S_list)
...
print("Tajima's D: %f, %f" % (lower_third, upper_third))
S_lower_third, S_upper_third = find_thirds(S_list)
print("S: %f, %f" % (S_lower_third, S_upper_third))
...
#         output[i,5] = 1
# --------------------------------------------
# Below: To use to do accuracy analysis for Tajima's D
# confusion_matrix_d = np.zeros((3,3))
# for idx in range(output.shape[0]):
#    output_vector = output[idx,:]
#    locations = np.flatnonzero(output_vector)
#    x = locations[0]
#    y = locations[1] - 3
#    confusion_matrix_d[x,y] += 1
# print(confusion_matrix_d)
# print("row    : constant, bottleneck, nat. sel.")
# print("column : < 0, = 0, > 0")
# --------------------------------------------
